 ...
 */
@Data
@Document("abnormal_charge_log")
public class AbnormalChargeLog implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    private Long id;

    private Long abnormalChargeId;
    ...
    public static final String ABNORMAL_CHARGE_ID = "abnormalChargeId";
    ...
    public static final String OPERATE_UID = "operateUid";
